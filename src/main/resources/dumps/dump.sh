...
zip src/main/resources/dumps/DrawStatsUpToDraw"$DRAW_ID".zip src/main/resources/dumps/DrawStatsUpToDraw"$DRAW_ID".dmp
zip src/main/resources/dumps/DrawTemplatesUpToDraw"$DRAW_ID".zip src/main/resources/dumps/DrawTemplatesUpToDraw"$DRAW_ID".dmp
zip src/main/resources/dumps/FormulaStatsUpToDraw"$DRAW_ID".zip src/main/resources/dumps/FormulaStatsUpToDraw"$DRAW_ID".dmp
